package io.github.allanshih.pipelinedemo.pipeline;
...
public class TestAPI {
    ...
    private static final String ENDPOINT = HTTPS_PREFIX + "httpbin.org";
    private static final String MQTT_BROKER = "broker.hivemq.com:1883";
    private static final String MQTT_TLS_BROKER = "broker.hivemq.com:443";
    ...
    private static final String MQTT_EVENT_TOPIC = "%s/events";
    private static final String MQTT_TELEMETRY = "%s/band/telemetry";
    private static final String MQTT_STATUS = "%s/status";
